...
if(expirydate>today):
    ...
    if (False):
        ...
        print("19th December 2021, 11:00 AM- 11:30 AM")
        print("19th December 2021, 02:00 PM- 02:30 PM")
        print("19th December 2021, 05:00 PM- 05:30 PM")
        #print("31 December 2021, 10:00 PM- 11:30 PM")
    ...
    while(True):
        ...
        if(bhai==code):
            clear()
            print("----------Your play time-----------")
            print("19th December 2021, 02:30 PM- 03:00 PM")
            print("19th December 2021, 05:30 PM- 06:00 PM")
            print("19th December 2021, 10:30 PM- 11:30 PM")
            print("Please play on the given time, and ")
            print("If you think it is an error contact")
            print("wait.... starting....")
            time.sleep(20)
            ...
            system(banner)
            print("----------Your play time-----------")
            print("19th December 2021, 04:00 PM- 04:30 PM")
            print("19th December 2021, 06:00 PM- 06:30 PM")
            print("19th December 2021, 10:00 PM- 11:30 PM")
            print("Please play on the given time, and ")
            print("If you think it is an error contact")
            print("wait.... starting....")
            time.sleep(20)
